...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Deep%20Dives-45%20topics-2F81F7?style=for-the-badge" alt="topics" />
...
> distributed systems, security. Yahan **45 detailed topic deep-dives** (21 core + 11 deep-dives +
> 13 advanced) + **30 full system-design case studies** (TinyURL, Twitter, Uber, Payment, Maps, DynamoDB…) —
...
| **11 deep-dive + 13 advanced topics** | [Deep-dives](#-part-2--advanced-deep-dives) · [Advanced](#-part-3--advanced-topics-advanced_topicsreadmemd) |
...
| 13 | [Hot Key / Celebrity Problem](./Advanced_Topics/13_Hot_Key_Celebrity_Problem.md) | "Justin Bieber problem" - hot key/partition, celebrity fanout, sharded counters, salting |
...
├── Advanced_Topics/            ← 13 advanced deep-dives (own README)
...
│   └── 13_Hot_Key_Celebrity_Problem.md
