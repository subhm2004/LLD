...
public:
    ...
    // scattered validation problem ho skti hai ki har jagah mujhe validation krni pad rhi hai
    void execute()
    {
...
int main()
{
    ...
    // The problem: what if we forgot to set an important field?(inconsistent state problem)
    request4->execute();
