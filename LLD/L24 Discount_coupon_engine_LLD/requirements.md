...
4. System should allow **registering new coupons at runtime**.
...
15. Coupons should support **combinable** (stack on updated total) or **exclusive** Means “Bank lag gaya = baaki koi coupon na lage” → matlab uske baad wale nahi lagenge. Pehle wale already lag chuke hote hain — Banking unhe hatata nahi.
