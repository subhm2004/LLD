...
- [`../../deadlock_and_protection.cpp`](../../deadlock_and_protection.cpp) — original combined file
- [`../../lock_mechanism.cpp`](../../lock_mechanism.cpp) — `std::lock`
- [`../Concurrency_Patterns/`](../Concurrency_Patterns/) — design patterns
