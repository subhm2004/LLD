...
> **यह README पूरे repository का single source of truth है।**  
...
| **Standalone systems** | 17 projects | Interview-favourite real-world systems (Parking Lot, Uber, WhatsApp, etc.) |
...
| Runnable system demos | 17+ |
| Design patterns demonstrated | 20+ (GoF + Null Object) |
| Projects with `problem_statement.md` | 25+ |
| Projects with dedicated `README.md` | 17 |
...
3. [LRU / Rate Limiter](#rate_limiter_lld)
...
├── ATM_LLD/ … WhatsApp_LLD/                                       # 17 systems
...
| **Key takeaway** | Abstraction = *what*; implementation = *how* (hidden) |
...
| **Decorator** | L13, L14 | WhatsApp (notification decorators) |
| **Adapter** | L16, L18 | — |
| **Facade** | L11, L17, L18, L27, L31 | Most `core/` classes |
| **Command** | L15 | — |
...
| ⭐⭐⭐ | LRU Cache / Rate Limiter | Data structures + concurrency |
